...
SELECT add_retention_policy('analytics.dataapi_summary_hourly', drop_after => INTERVAL '3 weeks', schedule_interval => INTERVAL '1 day');
...
SELECT add_retention_policy('analytics.dataapi_summary_daily', drop_after => INTERVAL '2 years', schedule_interval => INTERVAL '1 week');
...
CALL refresh_continuous_aggregate('analytics.dataapi_summary_hourly', '2021-05-01', '2025-05-14');
CALL refresh_continuous_aggregate('analytics.dataapi_summary_daily', '2021-05-01', '2025-05-14');
CALL refresh_continuous_aggregate('analytics.dataapi_summary_monthly', '2021-05-01', '2025-05-14');
