...
def run_migrations_online() -> None:
    url = get_url()
    # Ensure the analytics schema exists before Alembic tries to create alembic_version in it.
    # Uses a separate autocommit connection so the DDL is visible to the migration transaction.
