...
- download
  ...
  and store it in the datadir's security-proxy/libs folder
...
_You will want to adjust the `otel.exporter.otlp.endpoint` to match the Vector instance, in charge of collecting the
data._
